...
const App = () => {
  ...
  return (
    <div style={styles.appContainer}>
      ...
      <a href="http://localhost:5000/api/transactions/combined-data?month=July" style={{ margin: '5px', padding: '10px', textDecoration: 'none' }}>
        <button style={{ padding: '10px' }}>Go to combined Data</button>
      </a>
      <a href="/" style={{ margin: '5px', padding: '10px', textDecoration: 'none' }}>
        <button style={{ padding: '10px' }}>Back to Home</button>
      </a>
      <a href=" http://localhost:5000/api/transactions/initialize-data" style={{ margin: '5px', padding: '10px', textDecoration: 'none' }}>
